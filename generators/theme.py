...
def main(base,scheme,weighted,preferential,N,term):
    pal = palette.main(base=base,scheme=scheme,weighted=weighted,preferential=preferential,N=N)
...
if __name__ == "__main__":
    ...
    thm = main(base=args.base,scheme=args.scheme,weighted=args.weighted,preferential=args.preferential,N=args.num,term=args.term)
    thm.preview()
